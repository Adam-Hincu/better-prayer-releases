...
It is easy to disappear into your computer. You open your PC to work, study, browse, or play. A prayer time arrives. You think, "I'll pray in a few minutes." The minutes stretch. The computer keeps pulling you back.

Better Prayer helps Muslims break that loop. It gives you prayer times, reminders, Quran reflection, fasting times, and Islamic events in a clean interface. For users who want a stronger nudge, it includes an optional lockdown feature that locks the computer at prayer time and encourages you to get up for wudu.

The goal is not to make prayer complicated. The goal is to make it harder for your computer to quietly steal the time you intended to give to Allah.
...
| **Auto and Manual Updates** | Updates automatically or check manually from inside the app. |
| **In-App Bug Reports** | Report bugs without leaving Better Prayer. |
| **Discord Community** | Feedback, support, and updates. |

## Prayer Lockdown

Prayer Lockdown is the flagship feature. It is designed for Muslims who use their computer heavily and want a real barrier between "prayer time has arrived" and "I will do it later."

When enabled, Better Prayer temporarily locks your device at selected prayer times. Instead of a notification you can ignore, the app creates a stronger interruption.

**Prayer Lockdown is optional.** Turn it off anytime and use Better Prayer as a normal prayer app.
...
Enable lockdown for any combination of Fajr, Dhuhr, Asr, Maghrib, and Isha.

## Prayer Times

The main screen answers one question: **what is the next prayer?**

See the next prayer, time remaining, today's full schedule, your preferred time format, and location-based times. The Prayer Times tab in the sidebar shows the next prayer at the top and the full list below.

## Prayer Reminders

Get a reminder 10 minutes before prayer and a notification at prayer time. Both are configurable, including which prayers you want notified about.
...
See the next Islamic event, time remaining, and whether Jumu'ah is today.
...
1. Download from [better-prayer.com](https://better-prayer.com) or [GitHub Releases](https://github.com/Adam-Hincu/better-prayer-releases/releases/latest).
2. Choose the `.exe` or `.msi` installer.
...
Better Prayer is currently available on Windows. macOS, Linux, iOS, and Android support are planned.

## Roadmap

- macOS and Linux releases
- iOS and Android companion apps
- Continued UI polish and a larger visual refresh

## FAQ

### What is Better Prayer?

An Islamic prayer app with prayer times, reminders, a Quran daily verse, fasting times, Islamic events, Jumu'ah awareness, and optional device lockdown at prayer time. **It is completely free.**
...
Built for computer users, with optional Prayer Lockdown that locks your device at selected prayer times so you step away for wudu and salah.

### Is lockdown required?

No. Turn it off in Settings anytime.
...
No. Internet is required. Sign-in is also required.

### Is Better Prayer open source?

No. Free to use, but source code is not public.

### Where can I report bugs?

In the app, or on [Discord](https://discord.gg/B6pFQjpy65).
...
Join the Better Prayer Discord for updates, support, and feedback: [discord.gg/B6pFQjpy65](https://discord.gg/B6pFQjpy65)
